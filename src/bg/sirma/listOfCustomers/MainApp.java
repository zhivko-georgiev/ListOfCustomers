...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.setTitle("ListOfCustomersApp");
     ...
     * is returned.
     * 
     * @param customer the person object to be edited
    ...
    public void setCustomerFilePath(File file) {
        ...
        if (file != null) {
            ...
            primaryStage.setTitle("ListOfCustomers App - " + file.getName());
        } else {
            prefs.remove("filePath");

            // Update the stage title.
            primaryStage.setTitle("ListOfCustomers App");
        }
    }
